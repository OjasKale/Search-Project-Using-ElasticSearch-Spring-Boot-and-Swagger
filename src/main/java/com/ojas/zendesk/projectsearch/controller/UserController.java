...
import com.ojas.zendesk.projectsearch.model.User;
import com.ojas.zendesk.projectsearch.service.UserService;

@RestController
@Api("Users Search APIs")
@RequestMapping(value= "/zensearch/user")
public class UserController {
	@Autowired 
	UserService userService;
	
//	/**
//	 * Method to save the User in the elastic-search.
//	 * @param user
//	 * @return User
//	 */
