...
import com.ojas.zendesk.projectsearch.service.TicketService;



@RestController
@Api("Tickets Search APIs")
@RequestMapping(value= "/zensearch/ticket")
...
//	/**
//	 * Method to save the Ticket in the elastic-search.
//	 * @param Ticket
//	 * @return Ticket
//	 */
//	@ApiOperation(value = "Save Ticket", nickname = "Save Ticket")
//	@PostMapping(value= "/save")
//	public Ticket saveTicket(@RequestBody Ticket org){
//		return ticketService.save(org);
//	}
